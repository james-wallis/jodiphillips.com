...
const layoutProps = {
  content: {
    h1: 'About Jodi',
    introduction: 'I feel the need to create, so I do. Whether it’s paint, digital tools or getting my hands dirty, I love expressing myself through art. \
...
class ArtistJodiPage extends React.Component {
  ...
  render() {
    ...
    const url = this.props.websiteAddress + '/aboutjodi';
    return <>
      <NextSeo
        title={title}
